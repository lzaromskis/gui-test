...
public class MonochromaticColorCompatibilityCalculatorTests {
	...
	public static Stream<Arguments> perfectCompatibilityColors() {
		return Stream.of(
			arguments(new PixelRGB(0xFF4C7F99), new PixelRGB(0xFF3D7A99)),
			arguments(new PixelRGB(0xFF371CBC), new PixelRGB(0xFF5F44E5))
		);
	}
	...
	public static Stream<Arguments> badCompatibilityColors() {
		return Stream.of(
			arguments(new PixelRGB(0xFF413299), new PixelRGB(0xFF903299)),
