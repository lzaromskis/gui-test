...
public class TriadicColorCompatibilityCalculatorTests {
	...
	public static Stream<Arguments> perfectCompatibilityColors() {
		return Stream.of(
				arguments(new PixelRGB(0xFFD42BAB), new PixelRGB(0xFFABD42B), new PixelRGB(0xFF2BABD4)),
	...
	public static Stream<Arguments> badCompatibilityColors() {
		return Stream.of(
				arguments(new PixelRGB(0xFF8300FF), new PixelRGB(0xFFFF00FB), new PixelRGB(0xFF0400FF)),
