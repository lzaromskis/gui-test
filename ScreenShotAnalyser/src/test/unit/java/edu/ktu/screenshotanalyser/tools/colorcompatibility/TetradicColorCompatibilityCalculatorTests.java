...
public class TetradicColorCompatibilityCalculatorTests {
    ...
    public static Stream<Arguments> perfectCompatibilityColors() {
        return Stream.of(arguments(new PixelRGB(0xFFD12E6B), new PixelRGB(0xFFBCD12E), new PixelRGB(0xFF2ED194), new PixelRGB(0xFF432ED1)),
    ...
    public static Stream<Arguments> badCompatibilityColors() {
        return Stream.of(arguments(new PixelRGB(0xFFE75618), new PixelRGB(0xFF18E756), new PixelRGB(0xFF5618E7), new PixelRGB(0xFF18A9E7)),
