...
public class LocalizedMessages {
    ...
    private void loadResources(File appFolder, AppContext appContext) {
        var valueFolders = new File(appFolder, "res").listFiles(pathName -> pathName.isDirectory() && pathName
            .getName()
            .startsWith("values"));
        ...
        if (null != valueFolders) {
            for (var valueFolder : valueFolders) {
                ...
                var resourceFiles = valueFolder.listFiles(pathName -> pathName
                    .getName()
                    .equals("strings.xml"));
                ...
                for (var resourceFile : resourceFiles) {
                    try {
                        ...
                        if (languageCode.equals("default")) {
                            ...
                            var predictedLanguage = appContext
                                .getSystemContext()
                                .predictLanguage(bigMessage.toString());
