                        ...
                        if (bounds.width - bounds.height > 100) {
                            ...
                            if ((null != msg) && (msg.length() > 0)) {
                                ...
                                if (!msg.equalsIgnoreCase(lang)) {
                                    ...
                                    File outputfile = new File(Settings.debugFolder + "a_" + UUID
                                        .randomUUID()
                                        .toString() + "1-------" + msg + "--" + lang + ".png");
                            ...
                            if (lang == "heb") // RTL lang only...
                            {
                                ...
                                BufferedImage newImage = new BufferedImage(icon.getWidth(), icon.getHeight(), BufferedImage.TYPE_INT_ARGB);
                                ...
                                if ((w1 != w2) || (h1 != h2)) {
                                    ...
                                    if (percentage >= 45.0) {
                                        File outputfile1 = new File(Settings.debugFolder + "a_" + UUID
                                            .randomUUID()
                                            .toString() + "1-------" + ".png");
                                        ImageIO.write(img1, "png", outputfile1);

                                        File outputfile2 = new File(Settings.debugFolder + "a_" + UUID
                                            .randomUUID()
                                            .toString() + "1-------" + ".png");
