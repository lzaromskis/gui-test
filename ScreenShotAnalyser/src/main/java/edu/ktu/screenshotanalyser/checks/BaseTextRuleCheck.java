...
public abstract class BaseTextRuleCheck extends BaseRuleCheck {
    ...
    private boolean isSpellingCorrectAnyLanguage(AppContext appContext, String message) {
        ...
        var languages = new Language[]{
            Languages.getLanguageForShortCode("en-US"), Languages.getLanguageForShortCode("en-GB"), Languages.getLanguageForShortCode("es")
        };
    ...
    private static String[] ignoredWords = new String[]{
        "dd-mm-yy",
        "apk",
        "facebook",
        "sdcard",
    ...
    private static final com.github.pemistahl.lingua.api.LanguageDetector languageDetectorShort = LanguageDetectorBuilder
        .fromAllLanguages()
        .build();
}
