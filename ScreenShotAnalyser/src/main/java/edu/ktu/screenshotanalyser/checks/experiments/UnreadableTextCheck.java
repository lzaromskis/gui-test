        ...
        if (message.getText() != null) {
            if (message
                ...
                if ((message.getBounds().height > 3) && (message.getBounds().width > 3)) {
                    var actualHeight = state
                        .getTestDevice()
                        .getPhysicalSize(message.getBounds().height);
                    ...
                    if (actualHeight < this.minHeight) {
                        if (message.getBounds().y + message.getBounds().height >= state.getImageSize().height) {
                            ...
                            if ((null != message.getParent()) && (message.getBounds().y + message.getBounds().height >= message
                                                                                                                            .getParent()
                                                                                                                            .getBounds().y + message
                                                                                                                            .getParent()
                                                                                                                            .getBounds().height)) {
                                ...
                                return "Text : [" + message.getText() + "] too small " + actualHeight + "mm " + message
                                    .getBounds()
                                    .toString();
                            }
                        }
